...
namespace ProcessMemory.Library
{
    public class ProcessMemory
    {
        ...
        #region Traverse Correnpondings
        public byte[] ReadByteArray(IntPtr pOffset, uint pSize, params long[] offsets) => ReadByteArray(Traverse(pOffset, offsets), pSize);
        public bool WriteByteArray(IntPtr pOffset, byte[] pBytes, params long[] offsets) => WriteByteArray(Traverse(pOffset, offsets), pBytes);
        ...
        public bool WriteStringUnicode(IntPtr pOffset, string pData, params long[] offsets) => WriteStringUnicode(Traverse(pOffset, offsets), pData);
        public bool WriteStringASCII(IntPtr pOffset, string pData, params long[] offsets) => WriteStringASCII(Traverse(pOffset, offsets), pData);
        public bool WriteBoolean(IntPtr pOffset, bool pData, params long[] offsets) => WriteBoolean(Traverse(pOffset, offsets), pData);
        public bool WriteChar(IntPtr pOffset, char pData, params long[] offsets) => WriteChar(Traverse(pOffset, offsets), pData);
        public bool WriteByte(IntPtr pOffset, byte pData, params long[] offsets) => WriteByte(Traverse(pOffset, offsets), pData);
        public bool WriteInt16(IntPtr pOffset, short pData, params long[] offsets) => WriteInt16(Traverse(pOffset, offsets), pData);
        public bool WriteInt32(IntPtr pOffset, int pData, params long[] offsets) => WriteInt32(Traverse(pOffset, offsets), pData);
        public bool WriteInt64(IntPtr pOffset, long pData, params long[] offsets) => WriteInt64(Traverse(pOffset, offsets), pData);
        public bool WriteUInt16(IntPtr pOffset, ushort pData, params long[] offsets) => WriteUInt16(Traverse(pOffset, offsets), pData);
        public bool WriteUInt32(IntPtr pOffset, uint pData, params long[] offsets) => WriteUInt32(Traverse(pOffset, offsets), pData);
        public bool WriteUInt64(IntPtr pOffset, ulong pData, params long[] offsets) => WriteUInt64(Traverse(pOffset, offsets), pData);
        public bool WriteFloat(IntPtr pOffset, float pData, params long[] offsets) => WriteFloat(Traverse(pOffset, offsets), pData);
        public bool WriteDouble(IntPtr pOffset, double pData, params long[] offsets) => WriteDouble(Traverse(pOffset, offsets), pData);
        #endregion
    }
}
